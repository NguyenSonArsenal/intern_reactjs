...
class InlineEditor extends React.Component {
  ...
  handleSave(id, tagline, skillName) {
    this.props.dispatch({
      type: 'EDIT_TAGLINE', tagline, id, skillName
    });
      ...
      <div className={classNames('inline-editor')}>
        ...
        <div className="control-edit">
          ...
          <div
            ...
            onClick={() => this.handleSave(index, this.state.tagline, this.state.skillName)}
          >
            Save
          </div>
        </div>
